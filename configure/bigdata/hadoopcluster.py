...
#                                      data node coding
		...
		print "\n  first we will transfer file to this ip "+ip
		os.system("scp -r "+output+"/configure/datanode  "+ip+":/root/Desktop")

		os.system("tput setaf 1")		
		print "\n now we are doing ssh means remote server process"
		
		print "\n after ssh you first type the command ]#cd /root/Desktop/datanode\n then type the command]#chmod +x hadoop_data_node_java.py\n then enter the command\n]#./hadoop_data_node_java.py"
		os.system("tput setaf 0")	
		os.system("ssh -X root@"+ip)			
		...
		print "\n  first we will transfer file to this ip "+ip
		os.system("scp -r "+output+"/configure/client  "+ip+":/root/Desktop")
