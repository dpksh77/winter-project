...
print "intalling the jdk7"
os.system("tput setaf 0")
os.system("tput setaf 2")
os.system("rpm -ivh jdk-7u79-linux-x64.rpm")
os.system("tput setaf 0")

print "\n now we are set the path of the java variable"
...
print "enter the command to give permission and execute bash file\n]#chmod +x hadoop_name_node.py\n]#./hadoop_name_node.py"
os.system("exec bash")
