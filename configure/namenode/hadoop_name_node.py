...
print "\n Now format namenode so an inode table will be generate of this node"

print "\nto format namenode enter the command\n"
os.system("tput setaf 2")
print "]#hadoop namenode -format"
os.system("tput setaf 0")
nameformat=raw_input()
while(nameformat!="hadoop namenode -format"):
	print "command not found\n re-enter the command"
	nameformat1=raw_input()			
	if(nameformat1=="hadoop namenode -format"):
		print "command ok"
...
print "\nbefore start sevice we will flush ip tables"
...
print "\nnow we will start namenode sevice"
print "\nto start sevice enter the command\n"
os.system("tput setaf 2")
print "]#hadoop-daemon.sh start namenode"
os.system("tput setaf 0")
hadoopser=raw_input()
while(hadoopser!="hadoop-daemon.sh start namenode"):
	print "command not found\n re-enter the command"
	hadoopser1=raw_input()			
	if(hadoopser1=="hadoop-daemon.sh start namenode"):
		print "command ok"
...
print "\nnow we will check report of the namenode"
